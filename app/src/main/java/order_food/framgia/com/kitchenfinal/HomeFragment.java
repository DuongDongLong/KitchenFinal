...
import order_food.framgia.com.kitchenfinal.adapter.OrderViewHolder;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = LayoutInflater.from(container.getContext()).inflate(R.layout.home_fragment, container, false);
        ...
        options = new FirebaseRecyclerOptions.Builder<Order>().setQuery(databaseReference.orderByChild("status").equalTo("accept"), new SnapshotParser<Order>() {
            @NonNull
            @Override
        ...
        adapter = new FirebaseRecyclerAdapter<Order, OrderViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final OrderViewHolder holder, int position, @NonNull final Order oder) {
                ...
                holder.setItemClickListener(new OnClickItem() {
                    ...
                    public void setOnClickItem(int position) {
                        ...
                        OrderDetailFragment notificationDetailFragment=new OrderDetailFragment();
            ...
            public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View view1 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_item_oder, viewGroup, false);
